...
with tab1:
    ...
    if filtered_tab1.empty:
        ...
        def build_feeder_drilldown(df, label, cmap_zone):
            ...
            # ── Full styled render (still INSIDE the function) ───────
        ...
        # ← function ends here — nothing after this line should be indented inside it
        ...
        # SECTION B: Feeder-level Drill-down
        st.divider()
...
with tab3:
    ...
    if df_ptw_master.empty:
        ...
        if filtered_ptw.empty:
            ...
            # KPI counts BEFORE exploding feeders
